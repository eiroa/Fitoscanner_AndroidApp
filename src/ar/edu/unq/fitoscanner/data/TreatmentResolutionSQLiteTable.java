...
public class TreatmentResolutionSQLiteTable {
	...
	public static final String COLUMN_TREATMENTR_NAME = "idSample";
	public static final String COLUMN_TREATMENTR_DESCRIPTION = "description";
	...
	public static String[] ALL_COLUMNS = {
			...
			TreatmentResolutionSQLiteTable.COLUMN_TREATMENTR_NAME,
			TreatmentResolutionSQLiteTable.COLUMN_TREATMENTR_DESCRIPTION,
